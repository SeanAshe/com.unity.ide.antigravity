	...
	internal static class ProcessRunner
	{
		...
		public static string[] GetProcessWorkspaces(Process process)
		{
			...
			try
			{
...
#if UNITY_EDITOR_OSX
				storagePath = Path.Combine(userProfile, "Library", "Application Support", "antigravity", "User", "workspaceStorage");
#elif UNITY_EDITOR_LINUX
				storagePath = Path.Combine(userProfile, ".config", "Antigravity", "User", "workspaceStorage");
#else
				storagePath = Path.Combine(userProfile, "AppData", "Roaming", "antigravity", "User", "workspaceStorage");
#endif
				...
				{
					Debug.LogWarning($"[Antigravity] Workspace storage directory not found: {storagePath}");
				}
